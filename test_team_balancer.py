...
class TestTeamBalancer(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test data"""
        self.test_players = [
            {"Id": 1, "Name": "Player1", "Position": ["DF"], "Stats": {"level": 3.0, "stamina": 0, "speed": 0}, "Nationality": "🇪🇸"},
            {"Id": 2, "Name": "Player2", "Position": ["FW"], "Stats": {"level": 4.0, "stamina": 0, "speed": 0}, "Nationality": "🇦🇷"},
            {"Id": 3, "Name": "Player3", "Position": ["MF"], "Stats": {"level": 3.5, "stamina": 0, "speed": 0}, "Nationality": "🇧🇷"},
            {"Id": 4, "Name": "Player4", "Position": ["GK"], "Stats": {"level": 2.5, "stamina": 0, "speed": 0}, "Nationality": "🇨🇴"},
            {"Id": 5, "Name": "Player5", "Position": ["DF"], "Stats": {"level": 3.8, "stamina": 0, "speed": 0}, "Nationality": "🇲🇽"},
            {"Id": 6, "Name": "Player6", "Position": ["FW"], "Stats": {"level": 4.2, "stamina": 0, "speed": 0}, "Nationality": "🇻🇪"},
            {"Id": 7, "Name": "Player7", "Position": ["MF"], "Stats": {"level": 3.2, "stamina": 0, "speed": 0}, "Nationality": "🇮🇹"},
            {"Id": 8, "Name": "Player8", "Position": ["GK"], "Stats": {"level": 3.7, "stamina": 0, "speed": 0}, "Nationality": "🇪🇸"},
            {"Id": 9, "Name": "Player9", "Position": ["DF"], "Stats": {"level": 2.8, "stamina": 0, "speed": 0}, "Nationality": "🇦🇷"},
            {"Id": 10, "Name": "Player10", "Position": ["FW"], "Stats": {"level": 3.9, "stamina": 0, "speed": 0}, "Nationality": "🇧🇷"},
            {"Id": 11, "Name": "Player11", "Position": ["MF"], "Stats": {"level": 4.1, "stamina": 0, "speed": 0}, "Nationality": "🇨🇴"},
            {"Id": 12, "Name": "Player12", "Position": ["GK"], "Stats": {"level": 3.3, "stamina": 0, "speed": 0}, "Nationality": "🇲🇽"},
        ]
        
        # Players with multiple positions
        self.multi_position_players = [
            {"Id": 1, "Name": "Player1", "Position": ["DF", "MF"], "Stats": {"level": 3.0, "stamina": 0, "speed": 0}, "Nationality": "🇪🇸"},
            {"Id": 2, "Name": "Player2", "Position": ["FW", "MF"], "Stats": {"level": 4.0, "stamina": 0, "speed": 0}, "Nationality": "🇦🇷"},
            {"Id": 3, "Name": "Player3", "Position": ["MF", "DF"], "Stats": {"level": 3.5, "stamina": 0, "speed": 0}, "Nationality": "🇧🇷"},
            {"Id": 4, "Name": "Player4", "Position": ["GK"], "Stats": {"level": 2.5, "stamina": 0, "speed": 0}, "Nationality": "🇨🇴"},
            {"Id": 5, "Name": "Player5", "Position": ["DF", "GK"], "Stats": {"level": 3.8, "stamina": 0, "speed": 0}, "Nationality": "🇲🇽"},
            {"Id": 6, "Name": "Player6", "Position": ["FW"], "Stats": {"level": 4.2, "stamina": 0, "speed": 0}, "Nationality": "🇻🇪"},
            {"Id": 7, "Name": "Player7", "Position": ["MF", "FW"], "Stats": {"level": 3.2, "stamina": 0, "speed": 0}, "Nationality": "🇮🇹"},
            {"Id": 8, "Name": "Player8", "Position": ["GK", "DF"], "Stats": {"level": 3.7, "stamina": 0, "speed": 0}, "Nationality": "🇪🇸"},
            {"Id": 9, "Name": "Player9", "Position": ["DF"], "Stats": {"level": 2.8, "stamina": 0, "speed": 0}, "Nationality": "🇦🇷"},
            {"Id": 10, "Name": "Player10", "Position": ["FW", "MF"], "Stats": {"level": 3.9, "stamina": 0, "speed": 0}, "Nationality": "🇧🇷"},
            {"Id": 11, "Name": "Player11", "Position": ["MF"], "Stats": {"level": 4.1, "stamina": 0, "speed": 0}, "Nationality": "🇨🇴"},
            {"Id": 12, "Name": "Player12", "Position": ["GK", "MF"], "Stats": {"level": 3.3, "stamina": 0, "speed": 0}, "Nationality": "🇲🇽"},
        ]

    def test_filter_and_validate_positions(self):
        """Test position filtering and validation"""
        # Test valid positions
        player = {"Id": 1, "Name": "Test", "Position": ["DF", "MF"], "Stats": {"level": 3.0, "stamina": 0, "speed": 0}, "Nationality": "🇪🇸"}
        ...
        player_invalid = {"Id": 1, "Name": "Test", "Position": ["DF", "INVALID"], "Stats": {"level": 3.0, "stamina": 0, "speed": 0}, "Nationality": "🇪🇸"}
    ...
    def test_generate_balanced_teams_basic(self):
        ...
        # Each result should be a tuple with 5 elements
        for team_combo in result:
            self.assertEqual(len(team_combo), 5)
            team1, team2, team1_avg, team2_avg, diff = team_combo
            ...
            # Rating difference should be calculated correctly
            expected_diff = abs(team1_avg - team2_avg)
    ...
    def test_team_balance_optimization(self):
        ...
        if len(result) > 1:
            # Check that results are sorted by rating difference (ascending)
            for i in range(len(result) - 1):
                self.assertLessEqual(result[i][4], result[i + 1][4])  # diff should be <= next diff
    ...
    def test_diversity_filter(self):
        ...
        if len(result) > 1:
            ...
            for i in range(len(result) - 1):
                team1_a, team2_a, _, _, _ = result[i]
                team1_b, team2_b, _, _, _ = result[i + 1]
    ...
    def test_level_calculation(self):
        ...
        unbalanced_players = [
            {"Id": 1, "Name": "High1", "Position": ["FW"], "Stats": {"level": 5.0, "stamina": 0, "speed": 0}, "Nationality": "🇪🇸"},
            {"Id": 2, "Name": "High2", "Position": ["FW"], "Stats": {"level": 5.0, "stamina": 0, "speed": 0}, "Nationality": "🇦🇷"},
            {"Id": 3, "Name": "High3", "Position": ["FW"], "Stats": {"level": 5.0, "stamina": 0, "speed": 0}, "Nationality": "🇧🇷"},
            {"Id": 4, "Name": "Low1", "Position": ["DF"], "Stats": {"level": 1.0, "stamina": 0, "speed": 0}, "Nationality": "🇨🇴"},
            {"Id": 5, "Name": "Low2", "Position": ["DF"], "Stats": {"level": 1.0, "stamina": 0, "speed": 0}, "Nationality": "🇲🇽"},
            {"Id": 6, "Name": "Low3", "Position": ["DF"], "Stats": {"level": 1.0, "stamina": 0, "speed": 0}, "Nationality": "🇻🇪"},
        ]
        ...
        if result:
            team1, team2, team1_avg, team2_avg, diff = result[0]
            ...
            # Check that the difference is reasonable (not too high)
            self.assertLess(diff, 2.0)  # Should be well balanced
