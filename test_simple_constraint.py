#!/usr/bin/env python3
"""
Test with a simpler constraint to see if the issue is constraint complexity
"""
...
def test_simple_constraint():
    """Test with a simpler constraint"""
    
    print("🧪 Testing simple constraint...")
    ...
    # Test constraint: Team 1 should have players [30, 27] (only 2 players)
    per_team_constraints = {1: [[30, 27]]}
